...
export type IncomingMessage = IncomingCommandStartListening | IncomingCommandSetApiSchema | IncomingMessageDevice | IncomingMessageStation | IncomingMessageDriver;
export {};
